...
import com.immomo.wink.model.GradleSyncHandler;
...
//    }
    ...
    public static boolean isSameBuildMode(GradleBuildModel gradleBuildModel_a,GradleBuildModel gradleBuildModel_b){
        if(gradleBuildModel_a instanceof GradleBuildModelImpl && gradleBuildModel_b instanceof GradleBuildModelImpl){
            return ((GradleBuildModelImpl) gradleBuildModel_a).getDslFile().getName().equals(((GradleBuildModelImpl) gradleBuildModel_b).getDslFile().getName());
        }
        return false;
    }
