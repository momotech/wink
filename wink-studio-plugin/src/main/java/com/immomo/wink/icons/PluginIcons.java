...
public class PluginIcons {
    ...
    public static final Icon WinkIcon = load("/icons/wink4.svg");
    ...
    public static final Icon StartDebugger = intellijLoad("/actions/profileYellow.svg");
    ...
    /* Run action icon */
    public static final Icon ICON_ACTION_RUN = WinkIcon;
    /* Tool window icon */
